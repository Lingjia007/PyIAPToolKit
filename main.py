...
from alipay_sandbox_tools.alipay_sandbox_interface import AlipaySandbox_Widget
...
class Window(FluentWindow):
    ...
    def initNavigation(self):
        ...
        self.addSubInterface(self.alipaySandboxInterface, FIF.SHOPPING_CART, '支付宝沙盒')
